...
public class Solar_Power_System extends AppCompatActivity {
    ...
    private Spinner mElectricConnectionSpinnerAvailable;
    private TextView mSolarPowerSystemTextViewAssetOwner;
    private Spinner mElectricConnectionSpinnerAssetOwner;
    ...
    private Spinner mElectricConnectionSpinnerCellPanel;
    ...
    private Spinner mElectricConnectionSpinnerAmcYesNo;
    ...
    private void assignViews() {
        ...
        mElectricConnectionSpinnerAvailable = (Spinner) findViewById(R.id.electricConnection_Spinner_available);
        mSolarPowerSystemTextViewAssetOwner = (TextView) findViewById(R.id.solarPowerSystem_textView_assetOwner);
        mElectricConnectionSpinnerAssetOwner = (Spinner) findViewById(R.id.electricConnection_Spinner_assetOwner);
        ...
        mElectricConnectionSpinnerCellPanel = (Spinner) findViewById(R.id.electricConnection_Spinner_cellPanel);
        ...
        mElectricConnectionSpinnerAmcYesNo = (Spinner) findViewById(R.id.electricConnection_Spinner_amcYesNo);
